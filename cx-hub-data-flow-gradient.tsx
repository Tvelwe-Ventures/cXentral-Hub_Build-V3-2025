...
const DataFlowAnimationWithGradient = () => {
  ...
  const theme = {
    ...
    hubBorder: '#2358E9',
    particleFill: '#2358E9',
    // Gradient colors for dark and light modes
    gradientStart: isDarkMode ? '#11142B' : '#EBF3FF',
    gradientMiddle: isDarkMode ? '#1A1A3A' : '#F0F7FF',
    gradientEnd: isDarkMode ? '#171730' : '#F5FAFF'
  };
  ...
  return (
    <div className={`min-h-screen ${theme.bg} ${theme.text} font-sans transition-colors duration-300`}>
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {/* Main Animation Area */}
        <div className={`max-w-4xl mx-auto ${theme.cardBg} border ${theme.border} rounded-xl p-6 shadow-lg overflow-hidden`}>
          ...
          <div className="relative h-[500px] overflow-hidden rounded-lg">
            ...
            <div 
              ...
              style={{
                background: `radial-gradient(circle at 50% 50%, ${theme.gradientStart} 0%, ${theme.gradientMiddle} 50%, ${theme.gradientEnd} 100%)`
              }}
            >
              ...
              <div 
                ...
                style={{
                  backgroundImage: isDarkMode ? 
                    `linear-gradient(rgba(35, 88, 233, 0.03) 1px, transparent 1px), 
                    linear-gradient(90deg, rgba(35, 88, 233, 0.03) 1px, transparent 1px)` : 
                    `linear-gradient(rgba(35, 88, 233, 0.05) 1px, transparent 1px), 
                    linear-gradient(90deg, rgba(35, 88, 233, 0.05) 1px, transparent 1px)`,
              ...
              <div 
                className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-20 transition-opacity duration-500"
                style={{
                  width: '300px',
                  height: '300px',
                  background: `radial-gradient(circle, ${theme.hubBorder} 0%, transparent 70%)`,
            ...
            <svg width="100%" height="100%" viewBox="0 0 800 500" className="relative z-10">
              ...
              <g>
                <rect x="300" y="120" width="200" height="280" rx="8" fill={isDarkMode ? 'rgba(35, 88, 233, 0.15)' : 'rgba(35, 88, 233, 0.08)'} stroke={theme.hubBorder} strokeWidth="2" />
              ...
              {isPlaying && (
                <g>
                  ...
                  {/* Additional smaller particles for visual richness */}
                  <circle className="data-particle" r="2" fill={theme.particleFill} opacity="0.7">
                    <animateMotion
                      path="M140,100 C200,100 240,140 300,170"
                      dur={`${animationSpeed1 * 0.8}s`}
                      repeatCount="indefinite"
                      begin="0.5s"
                    />
                  </circle>
              ...
              {isPlaying && (
                <g>
                  ...
                  <circle cx="400" cy="260" r="20" fill="transparent" stroke={theme.hubBorder} strokeWidth="1" opacity="0.3">
        ...
        <div className={`max-w-4xl mx-auto mt-8 ${theme.cardBg} border ${theme.border} rounded-xl p-6 shadow-lg`}>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className={theme.mutedText}>
                The background uses a radial gradient that emanates from the center of the visualization. This creates depth
                and draws attention to the central processing hub. The gradient colors are theme-aware and change based on light/dark mode.
              </p>
            </div>
            
            <div>
              <h3 className="font-medium">Grid Pattern</h3>
              <p className={theme.mutedText}>
                A subtle grid overlay adds texture and depth to the background. This enhances the technical feel of the visualization
                while providing a sense of scale and dimension.
              </p>
            </div>
            ...
            <div>
              ...
              <p className={theme.mutedText}>
                The central pulsing glow behind the cXentral Hub creates visual interest and emphasizes the processing power
                of the platform. This effect uses CSS animations for better performance.
              </p>
            </div>
            
            <div>
              <h3 className="font-medium">CSS Animation Support</h3>
              <p className={theme.mutedText}>
                Add this CSS to your stylesheet for the pulse animation:
                <br />
...
export default DataFlowAnimationWithGradient;
